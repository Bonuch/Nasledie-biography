<template>
  <div class="edit-section" ref="section">
    <div class="edit-section__container">
      ...
      <div class="edit-section__content">
        <div class="edit-section__content-img">
          <PictureFigure
              v-if="this.getPhoto.photo ?? this.image"
...
export default {
  name: "EditPictLeftSection",
  components: {
    MediaModal,
    ChooseUploadType,
    CropperPhoto,
    EditPhotoCaption, PictureFigure, ButtonType, EditMainText, EditMainTitle
  },
  props: {
    sectionId: {
      type: Number,
